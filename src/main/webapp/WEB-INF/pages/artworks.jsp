	...
	<tiles:putAttribute name="body">
		...
		<h4 align="center">
			...
			<c:if test="${pageNumber==1}"> 
				...
				<spring:message code="page"/> ${pageNumber} <spring:message code="of"/> ${pageCount} 
			...
			<fieldset class="fieldsetView" >	
				...
				<tr> <td class="tdView"> 
						<span class="textCompetitionView"><c:out value="${work.competition.name}"></c:out></span>
